...
│   ├── icons/              # Ícones SVG (redes sociais, UI, skills, etc.)
│   │   └── skills/         # Ícones individuais de tecnologias
│   └── images/             # Imagens do portfólio
│       ├── avatar.webp
│       ├── avatars/        # Avatares de usuários
│       ├── certificates/   # Logos das empresas certificadoras
│       └── projects/       # Imagens dos projetos
│           └── thumbs/     # Miniaturas dos projetos
│
...
│   ├── skills.json
│   ├── certificates/       # Listagem de certificados
